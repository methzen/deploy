...
In this article, we'll walk through how to get your  [Next.js](https://nextjs.org/)  website indexed and crawled by Google.

To do this, we'll register your website in the  [Google Search Console](https://www.google.com/webmasters/tools/home)  and create a  `sitemap.xml`  for them to use when crawling your website.
...
First, go to the  [Google Search Console](https://www.google.com/webmasters/tools/home)  website.
...
![Google Search Console - Create a New Property](https://assets.coderrocketfuel.com/coding-blog-google-search-console-create-property.png)
...
![Google Search Console - Verify Ownership Property](https://assets.coderrocketfuel.com/coding-blog-google-search-console-verify-property.png)
...
![Google Search Console - Verify Property](https://assets.coderrocketfuel.com/coding-blog-google-search-console-verify-property.png)
...
![Google Search Console - Successful Property Verification](https://assets.coderrocketfuel.com/coding-blog-google-successful-property-verification.png)
...
Save the changes you made to the  `sitemap.xml`  file and open your browser window to  [http://localhost:3000/sitemap.xml](http://localhost:3000/sitemap.xml).

You should see the contents of your XML file displayed on the page.

![Sitemap.xml File Displayed in your Browser](https://assets.coderrocketfuel.com/coding-blog-sitemap-xml-browser-screenshot.png)

Then, you need to deploy this change to production to make your  `sitemap.xml`  file accessible to the world.

When you've finished your deployment process, visit your website in a browser and verify that the  `sitemap.xml`  file is served at this URL:  [https://example.com/sitemap.xml](https://example.com/sitemap.xml).
...
In your browser, go back to the  [Google Search Console](https://www.google.com/webmasters/tools/home).
...
![Google Search Console - Submit Sitemap](https://assets.coderrocketfuel.com/coding-blog-google-search-console-submit-sitemap.png)
...
![Google Search Console - Submit Sitemap Success](https://assets.coderrocketfuel.com/coding-blog-google-submit-sitemap-success.png)
